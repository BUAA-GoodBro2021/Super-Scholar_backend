...
def clear_cache_about_pdf():
    ...
    recommended_work_list_by_cited_count_key = json.dumps({
        ...
        "params": {
            "filter": {
                ...
                "to_publication_date": "2022-12-14"
            },
    ...
    recommended_work_list_by_publication_date_key = json.dumps({
        "entity_type": "works",
        "params": {
            "filter": {"to_publication_date": "2022-12-14"},
